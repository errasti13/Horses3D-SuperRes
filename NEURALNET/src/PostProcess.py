...
def main():
    ...
    Q_HO_SRGAN_reconstruct = reconstruct_field(Q_HO_SRGAN[LO_INDEX_OFFSET, :, :, :, :, :], config_nn.ho_polynomial)

    # Visualize the reconstructed data (Assuming this function is defined)
    #plot_reconstructed(Q_HO_ind_reconstruct, Q_HO_SRCNN_reconstruct, Q_HO_SRGAN_reconstruct)
    plot_reconstructed3D(Q_HO_ind_reconstruct)
